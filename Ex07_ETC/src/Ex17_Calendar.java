...
public class Ex17_Calendar {
    public static void main(String[] args) {
        ...
        // cla.get() 리턴 타입 >> 정수 >> 결과 >> 연산
        
        System.out.println("이 달의 몇째주 : " + cal.get(Calendar.WEEK_OF_MONTH));
        System.out.println("이 달의 며칠 : " + cal.get(Calendar.DAY_OF_MONTH));
        System.out.println("이 주의 며칠 : " + cal.get(Calendar.DAY_OF_WEEK));
        ...
        // 별도의 Class 설계 >> method 통해서 처리
        // 150페이지에 EduDate.today(); >> 호출 >> 변경 >> today함수 한번만 수정
